...
public:
   ...
   */
  RequestResponseClientHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create RequestResponseClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IPv6 address of the remote request response server
   * \param port The port number of the remote request response server
   */
  RequestResponseClientHelper (Ipv6Address ip, uint16_t port);
