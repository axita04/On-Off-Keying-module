...
static const uint32_t totalTxBytes = 1000;
...
myfile1.open("BER.dat");



for(double pow1 = 0.0 ; pow1 < 200 ; pow1 += 1.0){
  for(double pow = 0.0 ; pow < 200 ; pow+=1.0){
