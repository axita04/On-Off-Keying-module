...
//VLC---------------------------------------------------------
 OOKHelper OOK;
  ...
  a -> SetPosition (Vector (0.0,0.0,2.0));
  ...
  Ptr<VlcMobilityModel> c = CreateObject<VlcMobilityModel> ();
  Ptr<VlcMobilityModel> d = CreateObject<VlcMobilityModel> ();  

  c -> SetPosition (Vector (0.0,1.0,1.0));
  d -> SetPosition (Vector (0.0,0.0,0.0));
  c ->SetAzimuth(90.0);
  d ->SetAzimuth(0.0);
  c ->SetElevation(135.0);
  d ->SetElevation(0.0);
