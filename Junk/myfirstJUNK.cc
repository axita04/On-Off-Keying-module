...
staticRoutingRelay->AddHostRouteTo(Ipv4Address("10.1.2.1"), Ipv4Address("10.1.2.1"), 2,1);
...
dSrc.Get (1)->TraceConnectWithoutContext ("PhyTxEnd", MakeCallback (&RxEnd));
