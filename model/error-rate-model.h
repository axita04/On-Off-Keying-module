...
public:
   ...
   *          ber.
   */
  double CalculateSnr (double ber) const;
   ...
   */
  double GetChunkSuccessRate (double snr, uint32_t nbits);
};

  double CalculateBER(double snr,double channelDataRate, double bandwidth);
