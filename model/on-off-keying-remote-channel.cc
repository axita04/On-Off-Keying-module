...
#include "on-off-keying-remote-channel.h"
...
TypeId
OOKRemoteChannel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::OOKRemoteChannel")
    .SetParent<OOKChannel> ()
    .SetGroupName ("OOK")
    .AddConstructor<OOKRemoteChannel> ()
  ;
  return tid;
}

OOKRemoteChannel::OOKRemoteChannel ()
{
}
