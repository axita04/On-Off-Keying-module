...
main (int argc, char *argv[])
{
  ...
  Ptr<OnOffKeyingNetDevice> net0 = CreateObject<OnOffKeyingNetDevice> ();
  n0->AddDevice (net0);
  ...
  // single OnOffKeyingNetDevice (NetDevice 0) and added a 
  // DropTailQueue to it.
  ...
  // queue via the OnOffKeyingNetDevice attributes, where it is called
  // TxQueue 
  PointerValue ptr;
