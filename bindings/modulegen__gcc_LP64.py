...
def module_init():
    root_module = Module('ns.on_off_keying', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::OOKChannel [class]
    ...
    module.add_class('OnOffKeyingNetDevice', parent=root_module['ns3::NetDevice'])
...
def register_Ns3OOKHelper_methods(root_module, cls):
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::OOKHelper::OOKHelper(ns3::OOKHelper const & arg0) [copy constructor]
...
def register_Ns3OOKChannel_methods(root_module, cls):
    ...
    cls.add_method('GetDelay', 
                   ...
                   [], 
                   is_const=True, visibility='protected')
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Ptr<ns3::OnOffKeyingNetDevice> ns3::OOKChannel::GetDestination(uint32_t i) const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ptr< ns3::OnOffKeyingNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, visibility='protected')
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Ptr<ns3::OnOffKeyingNetDevice> ns3::OOKChannel::GetSource(uint32_t i) const [member function]
...
def register_Ns3OnOffKeyingNetDevice_methods(root_module, cls):
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::OnOffKeyingNetDevice::OnOffKeyingNetDevice() [constructor]
    cls.add_constructor([])
...
def register_Ns3OOKRemoteChannel_methods(root_module, cls):
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## on-off-keying-remote-channel.h (module 'on-off-keying'): bool ns3::OOKRemoteChannel::TransmitStart(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::OnOffKeyingNetDevice> src, ns3::Time txTime) [member function]
    cls.add_method('TransmitStart', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::OnOffKeyingNetDevice >', 'src'), param('ns3::Time', 'txTime')], 
                   is_virtual=True)
