...
def module_init():
    root_module = Module('ns.on-off-keying-module', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    module.add_enum('', ['DLT_NULL', 'DLT_EN10MB', 'DLT_OOK', 'DLT_RAW', 'DLT_IEEE802_11', 'DLT_PRISM_HEADER', 'DLT_IEEE802_11_RADIO', 'DLT_IEEE802_15_4'], outer_class=root_module['ns3::PcapHelper'], import_from_module='ns.network')
    ## trace-helper.h (module 'network'): ns3::PcapHelperForDevice [class]
    module.add_class('PcapHelperForDevice', allow_subclassing=True, import_from_module='ns.network')
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::OOKHelper [class]
    module.add_class('OOKHelper', parent=[root_module['ns3::PcapHelperForDevice'], root_module['ns3::AsciiTraceHelperForDevice']])
    ...
    ## OOK-header.h (module 'OOK-header'): ns3::OOKHeader [class]
    ...
    ## on-off-keying-channel.h (module 'on-off-keying-module'): ns3::OOKChannel [class]
    module.add_class('OOKChannel', parent=root_module['ns3::Channel'])
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::OnOffKeyingNetDevice [class]
    module.add_class('OOKNetDevice', parent=root_module['ns3::NetDevice'])
    ## on-off-keying-remote-channel.h (module 'on-off-keying'): ns3::OOKRemoteChannel [class]
    module.add_class('OOKRemoteChannel', parent=root_module['ns3::OOKChannel'])
...
def register_methods(root_module):
    ...
    register_Ns3OOKHelper_methods(root_module, root_module['ns3::OOKHelper'])
    ...
    register_Ns3OOKChannel_methods(root_module, root_module['ns3::OOKChannel'])
    register_Ns3OnOffKeyingNetDevice_methods(root_module, root_module['ns3::OnOffKeyingNetDevice'])
    register_Ns3OOKRemoteChannel_methods(root_module, root_module['ns3::OOKRemoteChannel'])
...
def register_Ns3OOKHelper_methods(root_module, cls):
    ## on-off-keying-helper.h (module 'on-off-keying-module'): ns3::OOKHelper::OOKHelper(ns3::OOKHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::OOKHelper const &', 'arg0')])
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::OOKHelper::OOKHelper() [constructor]
    cls.add_constructor([])
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::NetDeviceContainer ns3::OOKHelper::Install(ns3::NodeContainer c) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer', 'c')])
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::NetDeviceContainer ns3::OOKHelper::Install(ns3::Ptr<ns3::Node> a, ns3::Ptr<ns3::Node> b) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'a'), param('ns3::Ptr< ns3::Node >', 'b')])
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::NetDeviceContainer ns3::OOKHelper::Install(ns3::Ptr<ns3::Node> a, std::string bName) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'a'), param('std::string', 'bName')])
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::NetDeviceContainer ns3::OOKHelper::Install(std::string aName, ns3::Ptr<ns3::Node> b) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'aName'), param('ns3::Ptr< ns3::Node >', 'b')])
    ## on-off-keying-helper.h (module 'on-off-keying'): ns3::NetDeviceContainer ns3::OOKHelper::Install(std::string aNode, std::string bNode) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'aNode'), param('std::string', 'bNode')])
    ## on-off-keying-helper.h (module 'on-off-keying'): void ns3::OOKHelper::SetChannelAttribute(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('SetChannelAttribute', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## on-off-keying-helper.h (module 'on-off-keying'): void ns3::OOKHelper::SetDeviceAttribute(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('SetDeviceAttribute', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## on-off-keying-helper.h (module 'on-off-keying'): void ns3::OOKHelper::SetQueue(std::string type, std::string n1="", ns3::AttributeValue const & v1=ns3::EmptyAttributeValue(), std::string n2="", ns3::AttributeValue const & v2=ns3::EmptyAttributeValue(), std::string n3="", ns3::AttributeValue const & v3=ns3::EmptyAttributeValue(), std::string n4="", ns3::AttributeValue const & v4=ns3::EmptyAttributeValue()) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('std::string', 'type'), param('std::string', 'n1', default_value='""'), param('ns3::AttributeValue const &', 'v1', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n2', default_value='""'), param('ns3::AttributeValue const &', 'v2', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n3', default_value='""'), param('ns3::AttributeValue const &', 'v3', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n4', default_value='""'), param('ns3::AttributeValue const &', 'v4', default_value='ns3::EmptyAttributeValue()')])
    ## on-off-keying-helper.h (module 'on-off-keying'): void ns3::OOKHelper::EnableAsciiInternal(ns3::Ptr<ns3::OutputStreamWrapper> stream, std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool explicitFilename) [member function]
    cls.add_method('EnableAsciiInternal', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
    ## on-off-keying-helper.h (module 'on-off-keying'): void ns3::OOKHelper::EnablePcapInternal(std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool promiscuous, bool explicitFilename) [member function]
    cls.add_method('EnablePcapInternal', 
                   'void', 
                   [param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'promiscuous'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3OOKHeader_methods(root_module, cls):
    ...
    cls.add_method('Deserialize', 
                   ...
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## OOK-header.h (module 'on-off-keying'): ns3::TypeId ns3::OOKHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## OOK-header.h (module 'on-off-keying'): uint16_t ns3::OOKHeader::GetProtocol() [member function]
    cls.add_method('GetProtocol', 
                   'uint16_t', 
                   [])
    ## OOK-header.h (module 'on-off-keying'): uint32_t ns3::OOKHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## OOK-header.h (module 'on-off-keying'): static ns3::TypeId ns3::OOKHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## OOK-header.h (module 'on-off-keying'): void ns3::OOKHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## OOK-header.h (module 'on-off-keying'): void ns3::OOKHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## OOK-header.h (module 'on-off-keying'): void ns3::OOKHeader::SetProtocol(uint16_t protocol) [member function]
...
def register_Ns3NetDevice_methods(root_module, cls):
    ...
    cls.add_method('IsMulticast', 
                   ...
                   [], 
                   is_pure_virtual=True, is_const=True, is_virtual=True)
    ## net-device.h (module 'network'): bool ns3::NetDevice::IsOOK() const [member function]
    cls.add_method('IsOOK', 
                   'bool', 
                   [], 
                   is_pure_virtual=True, is_const=True, is_virtual=True)
...
def register_Ns3OOKChannel_methods(root_module, cls):
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::OOKChannel::OOKChannel(ns3::OOKChannel const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::OOKChannel const &', 'arg0')])
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::OOKChannel::OOKChannel() [constructor]
    cls.add_constructor([])
    ## on-off-keying-channel.h (module 'on-off-keying'): void ns3::OOKChannel::Attach(ns3::Ptr<ns3::OnOffKeyingNetDevice> device) [member function]
    cls.add_method('Attach', 
                   'void', 
                   [param('ns3::Ptr< ns3::OnOffKeyingNetDevice >', 'device')])
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Ptr<ns3::NetDevice> ns3::OOKChannel::GetDevice(uint32_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-channel.h (module 'on-off-keying'): uint32_t ns3::OOKChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Ptr<ns3::OnOffKeyingNetDevice> ns3::OOKChannel::GetOnOffKeyingDevice(uint32_t i) const [member function]
    cls.add_method('GetOnOffKeyingDevice', 
                   'ns3::Ptr< ns3::OnOffKeyingNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True)
    ## on-off-keying-channel.h (module 'on-off-keying'): static ns3::TypeId ns3::OOKChannel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## on-off-keying-channel.h (module 'on-off-keying'): bool ns3::OOKChannel::TransmitStart(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::OnOffKeyingNetDevice> src, ns3::Time txTime) [member function]
    cls.add_method('TransmitStart', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::OnOffkeyingNetDevice >', 'src'), param('ns3::Time', 'txTime')], 
                   is_virtual=True)
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Time ns3::OOKChannel::GetDelay() const [member function]
    cls.add_method('GetDelay', 
                   'ns3::Time', 
                   [], 
                   is_const=True, visibility='protected')
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Ptr<ns3::OOKNetDevice> ns3::OOKChannel::GetDestination(uint32_t i) const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ptr< ns3::OnOffKeyingNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, visibility='protected')
    ## on-off-keying-channel.h (module 'on-off-keying'): ns3::Ptr<ns3::OOKNetDevice> ns3::OOKChannel::GetSource(uint32_t i) const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ptr< ns3::OnOffKeyingNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, visibility='protected')
    ## on-off-keying-channel.h (module 'on-off-keying'): bool ns3::OOKChannel::IsInitialized() const [member function]
...
def register_Ns3OnOffKeyingNetDevice_methods(root_module, cls):
    ## on-off-keying-net-device.h (module 'on-off-keying'): static ns3::TypeId ns3::OnOffKeyingNetDevice::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::OnOffKeyingNetDevice::OnOffKeyingtNetDevice() [constructor]
    cls.add_constructor([])
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetDataRate(ns3::DataRate bps) [member function]
    cls.add_method('SetDataRate', 
                   'void', 
                   [param('ns3::DataRate', 'bps')])
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetInterframeGap(ns3::Time t) [member function]
    cls.add_method('SetInterframeGap', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::Attach(ns3::Ptr<ns3::OOKChannel> ch) [member function]
    cls.add_method('Attach', 
                   'bool', 
                   [param('ns3::Ptr< ns3::OOKChannel >', 'ch')])
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetQueue(ns3::Ptr<ns3::Queue> queue) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('ns3::Ptr< ns3::Queue >', 'queue')])
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Ptr<ns3::Queue> ns3::OnOffKeyingNetDevice::GetQueue() const [member function]
    cls.add_method('GetQueue', 
                   'ns3::Ptr< ns3::Queue >', 
                   [], 
                   is_const=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetReceiveErrorModel(ns3::Ptr<ns3::ErrorModel> em) [member function]
    cls.add_method('SetReceiveErrorModel', 
                   'void', 
                   [param('ns3::Ptr< ns3::ErrorModel >', 'em')])
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::Receive(ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('Receive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p')])
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetIfIndex(uint32_t const index) [member function]
    cls.add_method('SetIfIndex', 
                   'void', 
                   [param('uint32_t const', 'index')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): uint32_t ns3::OnOffKeyingNetDevice::GetIfIndex() const [member function]
    cls.add_method('GetIfIndex', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Ptr<ns3::Channel> ns3::OnOffKeyingNetDevice::GetChannel() const [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::Channel >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetAddress(ns3::Address address) [member function]
    cls.add_method('SetAddress', 
                   'void', 
                   [param('ns3::Address', 'address')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Address ns3::OnOffKeyingNetDevice::GetAddress() const [member function]
    cls.add_method('GetAddress', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::SetMtu(uint16_t const mtu) [member function]
    cls.add_method('SetMtu', 
                   'bool', 
                   [param('uint16_t const', 'mtu')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): uint16_t ns3::OnOffKeyingNetDevice::GetMtu() const [member function]
    cls.add_method('GetMtu', 
                   'uint16_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-Keying'): bool ns3::OnOffKeyingNetDevice::IsLinkUp() const [member function]
    cls.add_method('IsLinkUp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-Keying'): void ns3::OnOffKeyingNetDevice::AddLinkChangeCallback(ns3::Callback<void,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> callback) [member function]
    cls.add_method('AddLinkChangeCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::IsBroadcast() const [member function]
    cls.add_method('IsBroadcast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Address ns3::OnOffKeyingNetDevice::GetBroadcast() const [member function]
    cls.add_method('GetBroadcast', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::IsMulticast() const [member function]
    cls.add_method('IsMulticast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Address ns3::OnOffKeyingNetDevice::GetMulticast(ns3::Ipv4Address multicastGroup) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv4Address', 'multicastGroup')], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::IsOOK() const [member function]
    cls.add_method('IsOOK', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::IsBridge() const [member function]
    cls.add_method('IsBridge', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::Send(ns3::Ptr<ns3::Packet> packet, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('Send', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::SendFrom(ns3::Ptr<ns3::Packet> packet, ns3::Address const & source, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('SendFrom', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'source'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Ptr<ns3::Node> ns3::OnOffKeyingNetDevice::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::NeedsArp() const [member function]
    cls.add_method('NeedsArp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): ns3::Address ns3::OnOffKeyingNetDevice::GetMulticast(ns3::Ipv6Address addr) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv6Address', 'addr')], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::SetPromiscReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::Address const&, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetPromiscReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::Address const &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): bool ns3::OnOffKeyingNetDevice::SupportsSendFrom() const [member function]
    cls.add_method('SupportsSendFrom', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::DoMpiReceive(ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('DoMpiReceive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p')], 
                   visibility='protected')
    ## on-off-keying-net-device.h (module 'on-off-keying'): void ns3::OnOffKeyingNetDevice::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
...
def register_Ns3OOKRemoteChannel_methods(root_module, cls):
    ## on-off-keying-remote-channel.h (module 'on-off-keying'): ns3::OOKRemoteChannel::OOKRemoteChannel(ns3::OOKRemoteChannel const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::OOKRemoteChannel const &', 'arg0')])
    ## on-off-keying-remote-channel.h (module 'on-off-keying'): ns3::OOKRemoteChannel::OOKRemoteChannel() [constructor]
    cls.add_constructor([])
    ## on-off-keying-remote-channel.h (module 'on-off-keying'): static ns3::TypeId ns3::OOKRemoteChannel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## on-off-keying-remote-channel.h (module 'on-off-keying'): bool ns3::OnOffKeyingRemoteChannel::TransmitStart(ns3::Ptr<ns3::Packet> p, ns3::Ptr<ns3::OnOffKeyingNetDevice> src, ns3::Time txTime) [member function]
    cls.add_method('TransmitStart', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ptr< ns3::OnOffKeyingNetDevice >', 'src'), param('ns3::Time', 'txTime')], 
                   is_virtual=True)
